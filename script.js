...
// BELANGRIJK:
// Na een botsing kan de speler 1 seconde niet opnieuw geraakt worden.
...
function handleCollision(index) {
    ...
    // Deze auto meteen verwijderen.
    enemies.splice(index, 1);

    // PRECIES 1 leven eraf.
    lives--;
...
function draw() {
    ...
    // Speler
    // Knippert tijdens onkwetsbaarheid.
